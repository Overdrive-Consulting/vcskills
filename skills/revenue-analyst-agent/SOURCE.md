...
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `revenue-analyst-gr` to `revenue-analyst-agent`
- **Note:** upstream publishes this as revenue-analyst-gr.md, mirrored as SKILL.md
