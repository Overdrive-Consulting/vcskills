...
- **Upstream:** https://github.com/propane-ai/kits/tree/main/plugins/Founder/skills/stakeholder-comms
...
- **License:** Apache-2.0
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `stakeholder-comms` to `stakeholder-comms-skill`
