...
- **Upstream:** https://github.com/propane-ai/kits/tree/main/plugins/Founder/skills/sales-investor-emails
...
- **License:** Apache-2.0
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `sales-investor-emails` to `sales-investor-emails-skill`
