---
name: product-marketing-skill
description: Positioning, messaging pillars, value propositions, launch narrative, differentiation, sales/GTM enablement. Use when planning campaigns, drafting competitive briefs, or creating product-focused content.
---
...
- **~~knowledge base~~** (if connected): Positioning docs, messaging pillars, battlecards, launch playbooks, product narratives. See [REFERENCE.md](../../REFERENCE.md).
...
2. Pull positioning, messaging, and proof from ~~knowledge base~~, ~~CRM~~, ~~product analytics~~ per [REFERENCE.md](../../REFERENCE.md) when connected.
