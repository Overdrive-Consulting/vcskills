...
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `financial-analyst-fs` to `financial-analyst-agent`
- **Note:** upstream publishes this as financial-analyst-fs.md, mirrored as SKILL.md
