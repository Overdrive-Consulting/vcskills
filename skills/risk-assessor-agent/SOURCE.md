...
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `risk-assessor-fs` to `risk-assessor-agent`
- **Note:** upstream publishes this as risk-assessor-fs.md, mirrored as SKILL.md
