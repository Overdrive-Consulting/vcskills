...
- **Upstream:** https://github.com/propane-ai/kits/tree/main/plugins/GTM/skills/roi-calculator
- **Resolved repo:** propane-ai/kits
- **Path:** plugins/GTM/skills/roi-calculator
- **Commit:** 0069e243f75a90e8f6caa5426ebe31a6d047ea30
- **License:** Apache-2.0
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `roi-calculator` to `roi-calculator-skill`
