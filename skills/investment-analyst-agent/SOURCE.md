...
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `investment-analyst-fs` to `investment-analyst-agent`
- **Note:** upstream publishes this as investment-analyst-fs.md, mirrored as SKILL.md
