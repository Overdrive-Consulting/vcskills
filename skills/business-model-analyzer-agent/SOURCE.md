...
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `business-model-analyzer-mx` to `business-model-analyzer-agent`
- **Note:** upstream publishes this as business-model-analyzer-mx.md, mirrored as SKILL.md
