...
- **Upstream:** https://github.com/NicholasSpisak/claude-code-subagents/tree/main/agents/finance-strategy
- **Resolved repo:** NicholasSpisak/claude-code-subagents
- **Path:** agents/finance-strategy
- **Commit:** 1a16f36820d5db5516cf188712fcbb10ae63811c
- **License:** none declared
- **Mirrored:** 2026-07-27
- **Normalized:** frontmatter `name` changed from `business-strategist-fs` to `business-strategist-agent`
- **Note:** upstream publishes this as business-strategist-fs.md, mirrored as SKILL.md
